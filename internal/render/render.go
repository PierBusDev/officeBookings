...
// NewRenderer  set the app configuration
...
func Template(w http.ResponseWriter, r *http.Request, tmpl string, templData *models.TemplateData) error {
	...
	if !ok {
		return errors.New("Can't find template in the cache")
	}
